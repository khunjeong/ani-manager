...
- `skills/`: 역할별 페르소나 스킬 킷
- `docs/persona-skills.md`: 페르소나 스킬 활용 가이드
...
- 역할별 페르소나 문서가 있어 기획, 디자인, 개발, 인프라 판단 기준을 일관되게 맞출 수 있습니다.
...
5. `skills/` 기반으로 역할별 산출물 템플릿과 작업 프로세스를 더 자동화합니다.
